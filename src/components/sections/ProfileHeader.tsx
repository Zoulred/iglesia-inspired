      ...
      <CardContent className="flex flex-col md:flex-row gap-6">
        <div className="flex flex-col items-center md:items-start">
          ...
          <a 
            ...
            className="px-4 py-2.5 md:w-full md:px-6 md:py-2 bg-black [.cyberhacker_&]:bg-gradient-to-r [.cyberhacker_&]:from-red-600 [.cyberhacker_&]:to-red-700 text-white font-medium hover:bg-gray-800 [.cyberhacker_&]:hover:from-red-500 [.cyberhacker_&]:hover:to-red-600 transition-all shadow-md shadow-gray-300 dark:shadow-black/20 [.cyberhacker_&]:shadow-[0_0_20px_rgba(255,23,68,0.5)] [.cyberhacker_&]:hover:shadow-[0_0_25px_rgba(255,23,68,0.7)] text-center text-xs md:text-sm relative z-10 border border-black"
          >
           Need Help?
          </a>
        </div>
        ...
        <div className="text-center md:text-left flex-1 flex flex-col items-center md:items-start justify-center">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white [.cyberhacker_&]:text-transparent [.cyberhacker_&]:bg-clip-text [.cyberhacker_&]:bg-gradient-to-r [.cyberhacker_&]:from-cyan-300 [.cyberhacker_&]:via-cyan-400 [.cyberhacker_&]:to-blue-400 inline-flex items-center gap-2 whitespace-nowrap md:whitespace-normal break-words mb-2">
            {profile.name}
            <img src="/images/ver.png" alt="verified" title="Verified" className="w-6 h-6 flex-shrink-0" />
          </h1>
